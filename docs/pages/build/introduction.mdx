...
<BoxLink
  ...
  Icon={Cube01Icon}
/>
npx create-expo-app Notefinance
cd Notefinance
npx expo install expo-notifications expo-auth-session @supabase/supabase-js @react-native-async-storage/async-storage react-native-paper react-native-calendars react-native-color-picker expo-haptics expo-router react-native-reanimated react-native-modal @react-native-picker/picker
